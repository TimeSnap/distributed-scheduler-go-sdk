// Package distributed_scheduler_sdk_v1 provides primitives to interact with the openapi HTTP API.
//
// Code generated by github.com/oapi-codegen/oapi-codegen/v2 version v2.4.1 DO NOT EDIT.
package distributed_scheduler_sdk_v1
...
const (
	JobStatusAwaitingNextExecution ModelJobStatus = "AWAITING_NEXT_EXECUTION"
	JobStatusCancelled             ModelJobStatus = "CANCELLED"
	JobStatusCompleted             ModelJobStatus = "COMPLETED"
	JobStatusExecuted              ModelJobStatus = "EXECUTED"
	JobStatusRunning               ModelJobStatus = "RUNNING"
	JobStatusScheduled             ModelJobStatus = "SCHEDULED"
...
// HttpErrorResponse defines model for http.ErrorResponse.
...
type ModelAMQPJob struct {
	...
	// Connection Todo encode the connection string!
...
type ModelJob struct {
	...
	// Tags Custom user tags that can be used to filter jobs
...
type ModelJobExecution struct {
	...
	NumberOfExecutions *int    `json:"number_of_executions,omitempty"`
